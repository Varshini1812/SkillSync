...
import { Stepper, Step, Typography } from '../material-overrides';
  ...
  return (
    <div className="w-full py-4 px-8">
      <Stepper
        ...
        isLastStep={(value: boolean | ((prevState: boolean) => boolean)) => setIsLastStep(value)}
        isFirstStep={(value: boolean | ((prevState: boolean) => boolean)) => setIsFirstStep(value)}
      >
