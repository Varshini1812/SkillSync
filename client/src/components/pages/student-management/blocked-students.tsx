...
import { getAllBlockedStudents, unblockStudent } from '../../../api/endpoints/student-management';
...
const BlockedStudents: React.FC<Props> = ({ updated, setUpdated }) => {
  ...
  const { currentPage, totalPages, currentData, goToPage, goToPreviousPage, goToNextPage } =
