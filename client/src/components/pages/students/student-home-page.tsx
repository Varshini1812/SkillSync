...
const StudentHomePage: React.FC = () => {
  ...
  const [recommendedCourses, setRecommendedCourses] = useState<ApiResponseRecommended[] | null>(
    null
  );
      ...
      <div>
        ...
        <div className="lg:p-10 md:p-7 pt-7 sm:p-8 w-full">
          <div className="ml-10 flex items-center justify-start w-9/12">
            <Typography variant="h1" className="text-2xl  lg:text-4xl p-2 ml-2  font-semibold">
              Trending Courses
            </Typography>
          </div>
        ...
        {isLoggedIn && (
          <div className="lg:p-10 md:p-7 pt-5 sm:p-8 w-full">
            <div className="ml-10 flex items-center justify-start w-9/12">
              <Typography variant="h1" className="text-2xl  p-2 ml-2 lg:text-4xl font-semibold">
                Recommended Courses
              </Typography>
            </div>
