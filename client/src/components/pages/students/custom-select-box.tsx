...
const SelectInterest: React.FC = () => {
  ...
  return (
    <div className="mt-2">
      <label htmlFor="interests" className="block text-sm font-medium leading-5 text-gray-700">
        Interests
      </label>
      {categories ? (
        <Field
...
const CustomSelect = ({ field, form, options, ...props }: any) => {
  ...
  return <Select {...field} {...props} options={options} isMulti onChange={handleChange} />;
};
