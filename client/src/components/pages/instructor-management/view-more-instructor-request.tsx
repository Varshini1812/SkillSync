...
import { Button } from '../../material-overrides';
      ...
      <div className="bg-white mx-auto">
        <div className="px-4 py-6 sm:px-6">
          <div className="flex items-center">
            <img className="h-12 w-12 rounded-full" src={profilePic} alt="Profile" />
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          {certificates.length > 0 && (
            <div className="px-4 py-4 sm:py-6">
              <h4 className="text-lg leading-6 font-medium text-gray-900 mb-2">Certificates</h4>
                ...
                {certificates.map((certificate, index) => (
                  <div key={index} className="flex flex-col items-center ">
                    <img
                      ...
                      alt={'image'}
                    />
                    <span className="text-sm font-medium text-indigo-600">{certificate.name}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <dl className="divide-y divide-gray-200">
              <div className="grid grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{subjects.join(', ')}</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{formatDate(dateJoined)}</dd>
                </div>
              </div>
            </dl>
          </div>
