import { Card, CardHeader, CardBody, Typography, Avatar } from '../../material-overrides';
...
const InstructorCard: React.FC<InstructorApiResponse> = ({
  ...
  return (
    ...
    >
      ...
      <CardBody className="relative  px-6 md:px-12" style={{ height: 'calc(100% - 16rem)' }}>
        <Typography variant="h6" color="black" className="mb-6 text-gray text-md leading-[1.5]">
          {skills + ', ' + subjects},
        </Typography>
      </CardBody>
    </Card>
