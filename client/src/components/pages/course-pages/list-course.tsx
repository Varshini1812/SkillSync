      ...
      <div className="pt-5 pb-5 pl-9 pr-9 mt-5 mx-auto flex justify-center">
        <div className="w-10/12 ml-2 pl-1">
          ...
          <p className="text-gray-700 md:text-lg sm:text-xs">
            Choose from over {courses?.length} online video courses with new additions published
            every month
          </p>
        </div>
      </div>
          ...
          <div className="flex mt-3  flex-wrap justify-center">
            {courses.length ? (
              ...
              <div className="text-center pt-8 pb-14 mt-8">
                <MdSentimentDissatisfied className="mx-auto text-gray-500 mb-4" size={58} />
                <p className="text-gray-500 text-lg">No results found for the search query.</p>
              </div>
            )}
          </div>
        </div>
