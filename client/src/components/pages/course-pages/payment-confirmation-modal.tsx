      ...
      <Dialog open={open} size="sm" handler={handleOpen}>
        <DialogHeader>
          <div className="flex items-center justify-center">
            ...
            <Typography variant="h5" color="gray" className="ml-2 font-semibold">
        ...
        <DialogBody divider>
          ...
          <Typography variant="paragraph" color="gray" className="mt-2 mb-1">
            {isFreeCourse ? (
              <span className="font-semibold text-green-500">This course is free!</span>
            ) : (
              <div className="bg-gray-100 p-2">
                <p className="text-lg font-semibold mb-2">🎉 Limited Time Offer 🎉</p>
                <p className="text-xl font-bold mb-2">
                  Price: <span className="text-green-600">{formatToINR(courseDetails?.price)}</span>{' '}
                ...
                <p className="text-lg">
                  Offer Expires in:
                  <span className="text-gray-600 font-semibold">{formatTime(timeLeft)}</span>
                </p>
              </div>
            )}
          </Typography>
        ...
        <DialogFooter>
          <Button variant="gradient" color="green" onClick={handleCourseEnroll} className="w-full">
            {isLoading ? (
          ...
          <Button variant="outlined" color="blue" onClick={handleClose} className="w-full mt-2">
            <span>Cancel</span>
          </Button>
        </DialogFooter>
      </Dialog>
