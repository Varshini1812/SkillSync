            ...
            <ul className="flex p-3">
              ...
              <li
                className={`ml-5 cursor-pointer ${
                  selectedItemIndex === 0 ? 'border-b-4 rounded-b-md border-blue-gray-700' : ''
                }`}
                onClick={() => handleItemClick(0)}
              >
                About
              ...
              <li
                className={`ml-6 cursor-pointer ${
                  selectedItemIndex === 1 ? 'border-b-4 rounded-b-md  border-blue-gray-700' : ''
                }`}
              ...
              <li
                className={`ml-6 cursor-pointer ${
                  selectedItemIndex === 2 ? 'border-b-4 rounded-b-md  border-blue-gray-700' : ''
                }`}
