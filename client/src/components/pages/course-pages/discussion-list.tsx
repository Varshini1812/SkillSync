...
import { Menu, MenuHandler, MenuList, MenuItem, Button } from '../../material-overrides';
...
const DiscussionListEl: React.FC<Props> = ({
  ...
  const [discussionReplies, setDiscussionReplies] = useState<ApiResponseDiscussionReply[] | null>(
    null
  );
