...
import { Button, Chip } from '../../material-overrides';
          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div>
                ...
                {course?.isPaid ? (
                  <p className="text-gray-700">{formatToINR(course?.price ?? 0)}</p>
                ) : (
                  <Chip
                    variant="ghost"
                    color="green"
              ...
              <ul className="text-gray-700 bg-white mt-2 rounded-lg shadow-lg border-2">
                <li
                  className={` p-6 border-b-2 cursor-pointer ${
                    expandedIndex === 0 ? 'bg-blue-gray-50' : 'hover:bg-blue-gray-50'
                  }`}
                ...
                <li
                  className={` p-6 border-b-2 cursor-pointer ${
                    expandedIndex === 1 ? 'bg-blue-gray-50' : 'hover:bg-blue-gray-50'
                  }`}
