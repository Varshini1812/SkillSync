import { Rating } from '../../material-overrides';
    ...
    <div className="w-[18.5rem] p-5 text-customTextColor  hover:shadow-md hover:border hover:border-gray-300">
      ...
      <div className="pt-4">
        ...
        <div className="mt-4 flex justify-between items-center">
          <div className="group">
            <p
              className={`text-sm font-normal ${isPaid ? 'text-blue-gray' : 'text-white p-1 text-xs rounded-tl-lg rounded-br-lg  font-extrabold bg-green-400'}`}
            >
