...
import { Tooltip, Typography } from '../../material-overrides';
      ...
      <div className="w-11/12">
        <div>
          ...
          <div className="mb-2 pt-3">
            <h5 className="text-customFontColorBlack font-semibold">MY ASSIGNMENTS</h5>
          </div>
        </div>
        <div className="h-[30rem] flex flex-col md:flex-row gap-x-10">
          ...
          <div className="border my-5 md:mt-0 md:w-4/12 w-full h-full bg-white rounded-md border-gray-300">
            <div className="p-2 flex">
              <h2 className="text-customFontColorBlack font-bold pt-2 pl-2">My weekly goal</h2>
              <Tooltip
                content={
                  <div className="w-80">
            ...
            <div className="m-4 bg-gray-200 rounded-md">
              <h2 className="text-sm font-light p-2">
                Make it a habit! Each day that you complete a lecture, practice with a lab, or take
                a quiz or exam you'll build your learning streak.
              </h2>
            </div>
          </div>
        </div>
