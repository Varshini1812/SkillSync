    ...
    <form onSubmit={formik.handleSubmit}>
      <div className="relative z-0 w-full mb-6 group">
        ...
        <label
          ...
          className={`peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] ${
            formik.values.currentPassword ? 'peer-placeholder-shown:scale-100' : ''
      ...
      <div className="relative z-0 w-full mb-6 group">
        <input
          ...
          onBlur={formik.handleBlur}
          className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ${
            formik.touched.repeatPassword && formik.errors.repeatPassword ? 'border-red-500' : ''
          }`}
          placeholder=" "
        />
        {formik.touched.repeatPassword && formik.errors.repeatPassword && (
          <div className="text-red-500 text-xs mt-1">{formik.errors.repeatPassword}</div>
        )}
        <label
          htmlFor="floating_repeat_password"
          className={`peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] ${
            formik.values.repeatPassword ? 'peer-placeholder-shown:scale-100' : ''
          } peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6`}
        >
          Confirm password
        </label>
