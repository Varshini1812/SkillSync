import { Carousel, Typography, Button } from '../material-overrides';
import { Link } from 'react-router-dom';

export default function CarouselComponent() {
  return (
    <Carousel className="rounded-none h-[30rem]" autoplay={true} autoplayDelay={7000} loop={true}>
      ...
      <div className="relative h-full w-full">
        ...
        <div className="absolute inset-0 grid h-full w-full items-end bg-black/75">
          <div className="w-3/4 pl-12 pb-12 md:w-2/4 md:pl-20 md:pb-20 lg:pl-32 lg:pb-32">
            ...
            <Typography variant="lead" color="white" className="mb-12 opacity-80">
              Discover new subjects and gain expertise in your area of interest. Our platform offers
              a wide range of courses to cater to your learning goals.
            </Typography>
            <div className="flex gap-2">
              <Link to="/courses">
                <Button size="lg" color="white">
