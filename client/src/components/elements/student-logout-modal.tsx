...
export default function LogoutConfirmationModal({ open, setOpen, onConfirmLogout }: ModalProps) {
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <p className="mt-2 text-sm text-gray-800">Are you sure you want to log out?</p>
                  </div>
                </div>
              </div>
