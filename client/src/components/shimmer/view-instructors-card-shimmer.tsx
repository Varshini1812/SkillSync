...
import { Card, CardHeader, CardBody, Typography } from '../material-overrides';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography variant="h5" className="mb-2 w-36 h-6 bg-gray-300">
          {' '}
        </Typography>

        <Typography variant="h6" className="w-64 h-4 mb-5 bg-gray-300">
          {' '}
        </Typography>
      </CardHeader>
